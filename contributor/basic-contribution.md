...
如需参加社区 TSC/SIG 等组织会议，请访问[社区会议看板]()获取详细信息。社区提供[会议材料模板]()，您可在对应会议白板上申报议题。具体操作步骤请参阅：[社区会议指南]()。

## 2. 参与社区邮件讨论

关注社区 TSC/SIG 等组织动态的用户，可通过订阅[社区邮件列表]()获取最新消息和历史信息归档（包括会议通知、会议纪要等），并且通过邮件参与讨论、发起讨论、求助、申报会议议题等。具体操作步骤请参阅：[邮件列表使用指南]()。
